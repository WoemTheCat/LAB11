        ...
        btn_update.setOnClickListener(view -> {
            if (ed_book.length() < 1 || ed_price.length() < 1)
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(MainActivity.this, "更新失敗:" + e.getMessage().toString(), Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btn_delete.setOnClickListener(view -> {
            if (ed_book.length() < 1)
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(MainActivity.this, "刪除失敗:" + e.getMessage().toString(), Toast.LENGTH_SHORT).show();
                }
            }
        });
